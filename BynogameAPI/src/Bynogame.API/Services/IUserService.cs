...
namespace BYNOGAME.API.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        {
            new User { Id = 1, Ad = "Berkay", Soyad = "Senler", KullaniciAdi = "kaissu", Sifre = "1234" },
            new User { Id = 2, Ad = "Bugra", Soyad = "Ilci", KullaniciAdi = "banana", Sifre = "4321" }
        };
